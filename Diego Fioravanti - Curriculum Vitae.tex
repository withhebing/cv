...
\begin{document}
    ...
    \ecvsection{Work experience}
  		\ecvtitle{09/2016 -- Present}{Junior Analyst}
  		    \ecvitem{}{Accenture Italia, Verona (Italy)}
			\ecvitem{}{Junior analyst supporting the day to day operation of the Generali insurance company. Working daily an 100+ million record database and handling the client request for analysis and corrections.}
  

		\ecvtitle{2009 -- 2016}{Private tutor in mathematics}
	...
	\ecvsection{Technical Experience}
 		...
 		\ecvblueitem{Languages and technologies}{
			\begin{ecvitemize}
	  			...
	  			\item Intermediate: Haskell, Django, Matlab/Octave, (Neo)Vim, GIMP, TDD metodology, SQL
